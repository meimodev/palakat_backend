...
export class MembershipService {
  ...
  async create(createMembershipDto: CreateMembershipDto): Promise<{ message: string; data: Membership }> {
  ...
  async findAll(church_id?: number, column_id?: number): Promise<{ message: string; data: Membership[] }> {
  ...
  async update(id: number, updateMembershipDto: UpdateMembershipDto): Promise<{ message: string; data: Membership }> {
  ...
  // Helper method
  private async validateRelatedEntities(accountId: number, churchId: number, columnId: number) {
